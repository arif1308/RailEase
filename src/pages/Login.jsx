    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <p style={{ color: subText, fontSize: '14px', margin: 0 }}>Apni journey shuru karo!</p>
        </div>
        ...
        <form onSubmit={handleLogin}>
          ...
          <button
            type="submit"
            style={{ width: '100%', padding: '14px', background: 'linear-gradient(135deg, #1a73e8, #0d47a1)', color: 'white', border: 'none', borderRadius: '10px', fontSize: '16px', fontWeight: 'bold', cursor: 'pointer', boxShadow: '0 4px 15px rgba(26,115,232,0.4)' }}
          >
            Login →
          </button>
          ...
          <p style={{ textAlign: 'center', marginTop: '20px', color: subText, fontSize: '14px' }}>
            Account nahi hai?{' '}
            <span onClick={() => navigate('/register')} style={{ color: '#1a73e8', cursor: 'pointer', fontWeight: '600' }}>
              Register karo
            </span>
          </p>
        </form>
